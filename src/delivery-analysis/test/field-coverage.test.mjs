...
function gateway() {
  return {
    ...
    async query(query) {
      ...
      if(query.group_by.length===1&&query.group_by[0]==='dt')return [{dt:'2026-09-19'}];
      const values={group_type:'A',entry_dt:'2026-08-24',stat_dt:'2026-09-19',users:2,records:2,axc:1,charge:10,achieved:1,unmet:1,target_min:.12,target_max:.12,target_count:2,rate_sum:.3,rate_count:2,rate_min:.1,rate_max:.2,is_entry:1,is_coupon:1,is_full_coupon:1,is_repurchase_7d:1,is_full_coupon_repurchase_7d:0};
