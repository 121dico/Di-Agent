...
func DefaultToolsets() []ToolsetInfo {
	return []ToolsetInfo{
		...
		{Name: "basic", Label: "基础群聊", Description: "包含群 Agent 列表、消息读取、Skill 查看等基础工具",
			ToolNames: []string{"list_conversation_agents", "get_messages", "get_agent_skill"}},
		{Name: "tasks", Label: "任务协作", Description: "包含任务看板的完整增删改查能力",
			ToolNames: []string{"list_conversation_agents", "get_messages", "get_agent_skill", "list_tasks", "create_task", "update_task", "move_task_status"}},
		{Name: "orchestrator", Label: "Orchestrator", Description: "编排器模板，包含会话、任务、群组管理和知识库搜索",
			ToolNames: []string{"list_conversation_agents", "get_messages", "get_agent_skill", "list_tasks", "create_task", "update_task", "move_task_status", "list_conversations", "get_group_info", "list_group_members", "list_knowledge_bases", "list_knowledge_files", "search_knowledge", "read_knowledge_file", "create_agent", "update_agent", "delete_agent", "list_toolsets"}},
		{Name: "agent_builder", Label: "Agent 创建", Description: "Agent 发现和详情查询工具",
			ToolNames: []string{"list_agents", "list_conversation_agents", "get_agent_skill", "list_agent_candidates", "list_machines", "get_agent_detail", "create_agent", "update_agent", "delete_agent", "list_toolsets"}},
